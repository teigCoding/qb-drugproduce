...
RegisterNetEvent("kaves_drugs:goOut")
AddEventHandler("kaves_drugs:goOut", function(args)
...
RegisterNetEvent("kaves_drugs:goIn")
AddEventHandler("kaves_drugs:goIn", function(args)
    if args.spot == "coke" then
